        ...
        try:
            if predict:
                with st.spinner('Getting Price'):
                    with open("C:/Users/hemap/Resale_flat_price.pkl",'rb') as f:
                        model = pickle.load(f)
                    with open("C:/Users/hemap/notebooks/town_ohe.pkl", 'rb') as f:
                        town_ohe = pickle.load(f)
                    with open("C:/Users/hemap/notebooks/flat_type_ohe.pkl",'rb') as f:
                        flat_type_ohe = pickle.load(f)
                    with open("C:/Users/hemap/notebooks/storey_range_ohe.pkl",'rb') as f:
                        storey_range_ohe = pickle.load(f)
                    with open("C:/Users/hemap/notebooks/flat_model_ohe.pkl",'rb') as f:
                        flat_model_ohe = pickle.load(f)
                    with open("C:/Users/hemap/notebooks/Resale_flat_scaler.pkl",'rb') as f:
